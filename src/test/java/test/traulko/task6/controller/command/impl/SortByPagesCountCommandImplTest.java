...
import com.traulko.task6.controller.command.impl.SortByNameCommandImpl;
...
public class SortByPagesCountCommandImplTest {
    Command sortByPagesCountCommand;

    @BeforeClass
    public void setUp() {
        sortByPagesCountCommand = new SortByPagesCountCommandImpl();
    }

    @AfterClass
    public void tearDown() {
        sortByPagesCountCommand = null;
    ...
    public void executeTest() {
        ...
        Map<String, Object> actual = sortByPagesCountCommand.execute(parameters);
